...
public class ItemServiceImpl implements ItemService {
	...
	public Producto update(Producto producto, Long id) {
		HttpEntity body = new HttpEntity<>(producto);
		
		ResponseEntity<Producto> response = clienteRest.exchange("http://servicio-productos/editar/{id}", HttpMethod.PUT, body, Producto.class);
